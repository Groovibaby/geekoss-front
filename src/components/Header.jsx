      ...
      <nav className="navbar navbar-expand-md navbar-dark bg-blue">
        <div className="container">
          <Link className="navbar-brand" to="/">
            <img src={Geekoss} className="img-brand" alt="Bienvenue sur Geekoss" />
          </Link>
          <div>
          ...
          <Link className="hidden-sm" to="/add-offer">
            <button type="button" className="btn btn-header">Déposer une annonce</button>
          </Link>
          {!auth.data ? 
          <div className="collapse navbar-collapse" id="navbarMenu">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item hidden">
                <a href="contact.html" className="nav-link">Nous contacter</a>
              </li>
            </ul>
          </div>
          :
